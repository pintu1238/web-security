...
TEXT = {
    ...
    'unavailable': (
        ...
        'स्थानीय AI जवाब तैयार नहीं कर सका। देखिए कि Ollama चल रहा है और मॉडल डाउनलोड है, फिर कोशिश कीजिए।'),
    'sources_available': (
...
def instruction(language):
    ...
    if language == 'Hindi':
        return '\nजवाब केवल सरल हिंदी में दीजिए। तथ्यों और संख्याओं को न बदलें।'
